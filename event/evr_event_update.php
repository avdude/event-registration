...
//function to post edited event form data to db
function evr_post_update_event(){
    global $wpdb;
        //retrieve post data
        //note about coupon code - coupon code information is not posted here, but from the item cost page.
                    ...
                    $event_location = esc_html((string)@$_REQUEST ['event_location']);
                    ...
                    $custom_cur = (string)@$_REQUEST['custome_cur'];
        	...
        	<div id="message" class="updated fade"><p><strong><?php _e('The Event details saved for ','evr_language'); echo stripslashes($event_name); _e(' has been updated!','evr_language');?></a></p>
